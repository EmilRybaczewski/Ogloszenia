...
--
-- Host: 127.0.0.1
-- Czas generowania: 01 Gru 2017, 13:24
...
(1, 'Mirek', 'Handlarz', '', 'mirek123', 'Mirek@test.pl'),
(2, 'Janusz', 'Kowalski', '', 'janusz123', 'janusz@test.pl'),
...
--
ALTER TABLE `wiadomosci`
  MODIFY `Id_wiad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
